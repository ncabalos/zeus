...
//-----------------------------------------------
void UnityPrintExpectedAndActualStrings(const char * expected,
                                        const char * actual)
{
...
int UnityCheckArraysForNull(UNITY_PTR_ATTRIBUTE const void * expected,
                            UNITY_PTR_ATTRIBUTE const void * actual, const UNITY_LINE_TYPE lineNumber,
                            const char * msg)
{
                              ...
                              const UNITY_DISPLAY_STYLE_T style)
{
    ...
    if (UnityCheckArraysForNull((UNITY_PTR_ATTRIBUTE void *)expected,
                                (UNITY_PTR_ATTRIBUTE void *)actual, lineNumber, msg) == 1)
        return;
    ...
    switch(style & ~UNITY_DISPLAY_RANGE_AUTO) {
        ...
        case UNITY_DISPLAY_STYLE_UINT16:
            while (elements--) {
                if (*(UNITY_PTR_ATTRIBUTE _US16 *)ptr_exp != *(UNITY_PTR_ATTRIBUTE _US16 *)
                    ptr_act) {
                    UnityTestResultsFailBegin(lineNumber);
                    UnityPrint(UnityStrElement);
                    UnityPrintNumberByStyle((num_elements - elements - 1),
        ...
        case UNITY_DISPLAY_STYLE_UINT64:
            while (elements--) {
                if (*(UNITY_PTR_ATTRIBUTE _US64 *)ptr_exp != *(UNITY_PTR_ATTRIBUTE _US64 *)
                    ptr_act) {
                    UnityTestResultsFailBegin(lineNumber);
                    UnityPrint(UnityStrElement);
                    UnityPrintNumberByStyle((num_elements - elements - 1),
        ...
        default:
            while (elements--) {
                if (*(UNITY_PTR_ATTRIBUTE _US32 *)ptr_exp != *(UNITY_PTR_ATTRIBUTE _US32 *)
                    ptr_act) {
                    UnityTestResultsFailBegin(lineNumber);
                    UnityPrint(UnityStrElement);
                    UnityPrintNumberByStyle((num_elements - elements - 1),
...
void UnityAssertEqualMemory( UNITY_PTR_ATTRIBUTE const void * expected,
                             ...
                             const UNITY_LINE_TYPE lineNumber)
{
    UNITY_PTR_ATTRIBUTE unsigned char * ptr_exp = (UNITY_PTR_ATTRIBUTE unsigned
            char *)expected;
    UNITY_PTR_ATTRIBUTE unsigned char * ptr_act = (UNITY_PTR_ATTRIBUTE unsigned
            char *)actual;
    _UU32 elements = num_elements;
    _UU32 bytes;
    UNITY_SKIP_EXECUTION;
