 ...
 */
struct xLIST_ITEM {
    configLIST_VOLATILE portTickType
    ...
    struct xLIST_ITEM * configLIST_VOLATILE
            pxNext;	/*< Pointer to the next xListItem in the list. */
    struct xLIST_ITEM * configLIST_VOLATILE
            pxPrevious;/*< Pointer to the previous xListItem in the list. */
...
typedef struct xLIST_ITEM
        xListItem;				/* For some reason lint wants this as two separate definitions. */
...
typedef struct xLIST {
    ...
    xListItem * configLIST_VOLATILE
    pxIndex;		/*< Used to walk through the list.  Points to the last item returned by a call to pvListGetOwnerOfNextEntry (). */
    xMiniListItem
